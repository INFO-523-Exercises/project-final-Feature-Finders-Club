...
::: nonincremental
![](images/apple_stock_table.png){fig-align="center" width="75%"}
:::

## Apple Inc. News Headlines Data
::: nonincremental
![](images/apple_headline.png){fig-align="center" width="75%"}
:::
...
[- Thresholding: Applies predefined thresholds to the compound score to categorize the text as positive, negative, or neutral based on the intensity of sentiment.]{style="font-size:23px;"}
:::
